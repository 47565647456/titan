...
[MemoryPackable]
[Alias("TradeEvent")]
public partial record TradeEvent
{
    /// <summary>
    ...
    /// </summary>
    [Id(2), MemoryPackOrder(2)] public required DateTimeOffset Timestamp { get; init; }

    /// <summary>
    /// Current trade session state (optional, included for context).
    /// </summary>
    [Id(3), MemoryPackOrder(3)] public TradeSession? Session { get; init; }

    /// <summary>
    /// User who triggered this event (if applicable).
    /// </summary>
    [Id(4), MemoryPackOrder(4)] public Guid? UserId { get; init; }

    /// <summary>
    /// Item involved in this event (for ItemAdded/ItemRemoved).
    /// </summary>
    [Id(5), MemoryPackOrder(5)] public Guid? ItemId { get; init; }
}
