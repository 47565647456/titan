...
public partial record ItemTypeDefinition
{
    /// <summary>
    /// Unique identifier for this item type (e.g., "sword_legendary", "potion_health").
    /// </summary>
    [Id(0), MemoryPackOrder(0)] public required string ItemTypeId { get; init; }
    ...
    /// </summary>
    [Id(3), MemoryPackOrder(3)] public int MaxStackSize { get; init; } = 1;

    /// <summary>
    /// Whether this item type can be traded between players.
    /// Set to false for soulbound/account-bound items.
    /// </summary>
    [Id(4), MemoryPackOrder(4)] public bool IsTradeable { get; init; } = true;

    /// <summary>
    /// Optional category for organization (e.g., "weapon", "consumable", "material").
    /// </summary>
    [Id(5), MemoryPackOrder(5)] public string? Category { get; init; }
}
